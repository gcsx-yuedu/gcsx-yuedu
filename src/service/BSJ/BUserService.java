...
public class BUserService {
    ...
    public List<BUser> queryUserById(int u_id){ return BUserDao.queryUserById(u_id);}
    public List<BBookShelf> queryShelfById(int u_id){ return BUserDao.queryShelfById(u_id);}
